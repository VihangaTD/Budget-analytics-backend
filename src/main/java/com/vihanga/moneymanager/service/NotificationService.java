...
public class NotificationService {
    ...
    @Value("${budget.analytics.frontend.url}")
    ...
    public void sendDailyIncomeExpenseReminder(){
        ...
        for (ProfileEntity profile:profiles){
            String body = "Hi "+profile.getFullName()+",<br><br>"
                    +"This is a friendly reminder to add your income and expenses for today in Budget Analytics.<br/><br/>"
                    +"<a href="+frontEndUrl+" style='display:inline-block;padding:10px 20px;background-color:#EFBF04;color:#fff;text-decoration:none;border-radius:5px;font-weight:bold;'>Go to Budget Analytics</a>"
                    +"<br/><br/>Best Regards,<br/>Budget Analytics Team";
    ...
    public void sendDailyExpenseSummary(){
        ...
        for (ProfileEntity profile:profiles){
            ...
            if (!todayExpenses.isEmpty()){
                ...
                table.append("</table>");
                String body = "Hi "+profile.getFullName()+",<br/><br/> Here is a summary of your expenses for today:<br/><br/>"+table+"<br/><br/>Best Regards,<br>Budget Analytics Team";
